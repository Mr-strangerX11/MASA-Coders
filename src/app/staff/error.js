  ...
  return (
    <div className="min-h-screen bg-[#0d1117] flex items-center justify-center px-4">
      <div className="text-center max-w-md bg-white/5 border border-white/10 rounded-2xl p-10">
        ...
        <p className="text-slate-400 text-sm mb-6">An unexpected error occurred in the staff portal.</p>
        <button onClick={reset} className="px-5 py-2.5 bg-violet-600 hover:bg-violet-500 text-white font-semibold rounded-xl transition-colors text-sm">
          Try Again
        </button>
      </div>
    </div>
